EvadeTaxes = RegisterMod("Evade Taxes: Fiend's Rocks and Scenery Collection",1)
local mod = EvadeTaxes	
...
if StageAPI then
	...
	StageAPI.NecropolisGridGfx:SetPits("gfx/grid/grid_necropolis_pit_large.png", nil, true)
	StageAPI.NecropolisGridGfx:SetRocks("gfx/grid/rocks_necropolis.png")
	...
	StageAPI.UteroGridGfx.PitFiles = mod.UteroGrid.PitFiles
	StageAPI.UteroGridGfx.BridgeFiles = mod.UteroGrid.BridgeFiles
	--StageAPI.UteroGridGfx.AltPitFiles = mod.UteroGrid.AltPitFiles
...
function mod:getCurrentRoomGfx()
	...
	elseif not StageAPI.InNewStage() then
		...
		elseif backdropType == 19 or backdropType == 21 or backdropType == 22 then
			return mod.CellarBackdrop
