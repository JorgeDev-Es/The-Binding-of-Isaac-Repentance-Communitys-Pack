...
local repCollectibles={
	...
	[110] = {"110", "Lentine di Mamma", "↑ {{Range}} +1.5 Gittata#{{Petrify}} 20% di chance di sparare lacrime pietrificanti#{{Luck}} 50% di chance con 20 di Fortuna"}, -- Mom's Contacts
	...
	[142] = {"142", "Scapolare", "{{SoulHeart}} Isaac ottiene 1 Cuore Celeste quando i danni lo riducono a mezzo cuore#Può avvenire solo 1 volta a stanza#Uscire e rientrare nella stanza permette di attivare nuovamente l'effetto#{{Warning}} Non viene attivato dalle donazioni di cuori"}, -- Scapular
	...
	[283] = {"283", "D100", "Raddoppia 1 consumabile nella stanza#Risorteggia Velocità, Lacrime, Danni, Gittata e gli oggetti passivi di Isaac#Risorteggia tutti i piedistalli, consumabili e rocce nella stanza#Fa ripartire la stanza, resuscita tutti i nemici e li risorteggia"}, -- D100
	...
	[382] = {"382", "Sfera Amikè", "Può essere lanciata ai nemici per catturarli#{{Friendly}} Usare l'oggetto dopo aver catturato un nemico lo genera come un compagno amichevole#Camminare sopra la sfera dopo la cattura ricarica istantaneamente l'oggetto"}, -- Friendly Ball
	...
	[386] = {"386", "D12", "Risorteggia gli ostacoli in altri ostacoli casuali (ad es. cacca, vasi, TNT, cacca rossa, blocchi di pietra etc.)#Piccola chance di risorteggiare gli ostacoli in pulsanti, tasterminatori, cunicoli o botole"}, -- D12
	...
	[405] = {"405", "Bug Rompigioco", "{{Throwable}} Lanciabile (doppia premuta del tasto di sparo)#Risorteggia i nemici e i consumabili con cui entra a contatto"}, -- GB Bug
	...
	[433] = {"433", "La mia Ombra", "Isaac viene seguito da una piccola ombra #{{Friendly}} Quando un nemico tocca l'ombra viene generato un Assalitore nero amichevole fino all'uscita dalla stanza#L'Assalitore infligge 8.7 danni a colpo"}, -- My Shadow
	...
	[450] = {"450", "Occhio di Avarizia", "Ogni 20 lacrime, Isaac spara una lacrima-moneta che infligge x1.5 dei danni +10#{{Petrify}} I nemici colpiti dalla moneta vengono pietrificati e tramutati in oro#{{Coin}} Un nemico dorato ucciso butta a terra 1-3 monete#{{Warning}} Sparare una lacrima-moneta costa 1 moneta"}, -- Eye of Greed
	...
	[459] = {"459", "Sinusite", "20% di chance di sparare una caccola appiccicosa#{{Damage}} Le caccole infliggono i danni di Isaac 1 volta al secondo e rimangono incollate per 60 secondi#{{Luck}} Non è influenzato dalla Fortuna"}, -- Sinus Infection
	...
	[468] = {"468", "Ombroso", "Segue i movimenti di Isaac con un delay di 1 secondo#Infligge 75 danni da contatto al secondo#{{Friendly}} Dopo aver inferto 666 danni, viene assorbito da Isaac, aumentando i suoi danni da contatto e generando Assalitori amichevoli"}, -- Shade
	...
	[522] = {"522", "Telecinesi", "Ferma tutti i proiettili che si avvicinano ad Isaac per 3 secondi e in seguito li risorteggia via#Durante l'effetto respinge via i nemici vicini"}, -- Telekinesis
	...
	[596] = {"596", "Uranus", "{{Freezing}} Isaac spara lacrime pietrificanti che congelano i nemici una volta morti#Toccare un nemico congelato lo fa scivolare via ed esplodere in 10 schegge di ghiaccio"}, -- Uranus
	...
	[608] = {"608", "Bebè Ghiacciato", "{{Petrify}} Spara lacrime pietrificanti#{{Freezing}} I nemici si congelano quando vengono uccisi"}, -- Freezer Baby
	[609] = {"609", "D6 Eterno", "Risorteggia tutti i piedistalli nella stanza#Ha il 25% di chance di cancellare gli oggetti invece di risorteggiarli"}, -- Eternal D6
	...
	[638] = {"638", "Gomma per Cancellare", "Lancia una gomma da cancellare che uccide istantemente un nemico#Impedisce per il resto della partita la generazione del nemico cancellato#Infligge 15 danni ai boss#Può essere usato 1 volta per piano"}, -- Eraser
	...
	[687] = {"687", "Cerca Amici", "{{Friendly}} Genera un mostro amichevole casuale che imita i movimenti e gli attacchi di Isaac"}, -- Friend Finder
	...
	[691] = {"691", "Sfera Sacra", "Previene la generazione di oggetti di Qualità {{Quality0}}/{{Quality1}}#Gli oggetti di Qualità {{Quality2}} hanno il 33% di chance di venire risorteggiati"}, -- Sacred Orb
	...
	[694] = {"694", "Crepacuore", "↑ {{Damage}} +0.25 Danni per Cuore Spezzato#{{BrokenHeart}} +3 Cuori Spezzati#{{BrokenHeart}} Ogni colpo letale conferisce +2 Cuori Spezzati#A 12 Cuori Spezzati Isaac muore"}, -- Heartbreak
	...
	[722] = {"722", "Anima Sola", "{{Chained}} Incatena il nemico più vicino per 5 secondi#I nemici incatenati non possono muoversi o attaccare"}, -- Anima Sola
	[723] = {"723", "Dado Decrementale", "Risorteggia tutti gli oggetti nella stanza, diminuendo di 1 il loro ID interno"}, -- Spindown Dice
	...
	[728] = {"728", "Gellò", "Un famiglio demoniaco fuoriesce da Isaac fino all'uscita dalla stanza#Il demone spara verso il nemico più vicino, imitando le lacrime, statistiche e effetti di Isaac#{{Damage}} Le sue lacrime infliggono il 75% dei danni di Isaac"}, -- Gello
	[729] = {"729", "Decapita Azione", "Lancia la testa di Isaac verso una direzione#La testa infligge danni da contatto e spara lacrime dal luogo in cui atterra#Usare di nuovo l'oggetto o calpestare la testa la rimette a posto"}, -- Decap Attack
...
EID.descriptions[languageCode].BookOfVirtuesWispTexts = {
	...
	Health = "{1} Salute", 		-- {1} will be replaced with the health
	Damage = "{1} DPS",				-- {1} will be replaced with the calculated damage
	CantShoot = "Non spara!",
	Shotspeed = "{1}% Velocità Colpi", 				-- {1} will be replaced with the shot speed changes in %
	Chance = " ({1}% di chance)",					-- {1} will be replaced with the chance
	SingleRoom = "Fiammella per una singola stanza",
	NoWisps = "Niente fiammelle",
	Ring = {
		[-1] = "{amount} fiammella/e stazionaria/e",
		[0] = "{amount} Fiammella/e dell'anello interno {{InnerWisp}}",
		[1] = "{amount} Fiammella/e dell'anello mediano {{MiddleWisp}}",
		[2] = "{amount} Fiammella/e dell'anello esterno {{OuterWisp}}",
	},
}
...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	[35] = "{{Collectible35}} Se distrutta attiva l'effetto di \"Necronomicon\"", -- The Necronomicon
	[37] = "Se distrutta butta a terra bombe a grappolo a ricerca", -- Mr. Boom
	[38] = "Lacrime imprecise", -- Tammy's Head
	[40] = "Se distrutta esplode", -- Kamikaze!
	[47] = "Se si usa l'oggetto spara 3 lacrime esplosive verso il mirino", -- Doctor's Remote
	[49] = "Se si usa l'oggetto spara un raggio", -- Shoop da Whoop!
	[56] = "La fiammella sgocciola del liquido giallo", -- Lemon Mishap
	[58] = "Immune ai proiettili#Immunità ai danni durante {{Collectible58}} il suo effetto", -- Book of Shadows
	[65] = "Se distrutta butta a terra una Bomba Troll", -- Anarchist Cookbook
	[66] = "{{Slow}} Se distrutta rallenta i nemici per 3 secondi", -- The Hourglass
	[77] = "Danni da contatto extra", -- My Little Unicorn
	[78] = "Se distrutta genera una Locusta fino all'uscita dalla stanza", -- Book of Revelations
	[85] = "Se distrutta lascia 1 {{Card}} carta", -- Deck of Cards
	...
	[102] = "Genera 1 tra 6 fiammelle:#lacrime normali che se distrutte generano un ragno nemico o chance di lacrime velenose, pietrificanti, contundenti, infuocate, o che generano Bombe Trolls#Tutte e 6 se distrutte generano una {{Pill}} pillola", -- Mom's Bottle of Pills
	[105] = "+1 Fiammella per oggetto risorteggiato", -- The D6
	[111] = "{{Poison}} Se distrutta rilascia una scorreggia velenosa", -- The Bean
	[123] = "Lacrime casuali", -- Monster Manual
	[124] = "Genera la fiammella dell'oggetto imitato", -- Dead Sea Scrolls
	[130] = "Le fiammelle caricano nella direzione in cui Isaac spara", -- A Pony
	[137] = "+1 Fiammella per bomba detonata#Anche le lacrime della fiammella possono venire detonate a distanza", -- Remote Detonator
	[145] = "Al posto delle mosche vengono generate fiammelle#Se distrutta genera 1 mosca blu", -- Guppy's Head
	...
	[284] = "Rimuove tutte le fiammelle e genera 1 fiammella casuale per ogni 2 oggetti posseduti#Non risorteggia \"Libro delle Virtù\"", -- D4
	[285] = "10% di chance di lacrime dagli effetti di \"D10\"", -- D10
	[286] = "Se distrutta genera 1 {{Card}} carta", -- Blank Card
	[287] = "Se distrutta attiva l'effetto di {{Collectible675}} \"Sfera Incrinata\"", -- Book of Secrets
	[288] = "Al posto dei ragni vengono generate fiammelle#Se distrutta genera un ragno blu", -- Box of Spiders
	[290] = "Crea una fiammella per cuore invece di buttarli a terra come consumabili#Se distrutta chance di generare 1 {{HalfHeart}} mezzo Cuore Rosso", -- The Jar
	[291] = "Genera una fiammella aggiuntiva per ogni nemico giù per lo scarico", -- Flush!
	[292] = "+10% di chance di una {{AngelDevilChance}} Stanza del Diavolo/dell'Angelo per ogni fiammella di \"Bibbia Satanica\"", -- Satanic Bible
	[293] = "Se distrutta spara un raggio di {{Collectible118}} \"Zolfo Fuso\" in 4 direzioni", -- Head of Krampus
	[294] = "Se distrutta attiva l'effetto di \"Fagiolo di Lima\"", -- Butter Bean
	[295] = "Se distrutta chance di generare 1 {{Coin}} moneta", -- Magic Fingers
	[296] = "Può essere curata con {Heart}} Cuori Rossi", -- Converter
	[297] = "Genera 0-8 fiammelle in base al piano", -- Pandora's Box
	[298] = "Immunità ai danni da contatto#Non infligge danni da contatto a meno che non sia attivo l'effetto di \"Moncherino di Unicorno\" o uno simile", -- Unicorn Stump
	[323] = "Durata di vita di 3 secondi", -- Isaac's Tears
	[324] = "Lacrime di {{Collectible570}} \"Biscotto di Pongo\"", -- Undefined
	[325] = "Ammasso di lacrime ad arco", -- Scissors
	[326] = "Con una parata perfetta genera 4 fiammelle", -- Breath of Life
	[347] = "Lacrime di {{Collectible245}} \"Dieci Decimi\"#Duplica tutte le altre fiammelle", -- Diplopia
	[348] = "Se distrutta genera 1 {{Pill}} pillola", -- Placebo
	[349] = "Se distrutta 50% di chance di lasciare 1 {{Coin}} moneta", -- Wooden Nickel
	[351] = "Se usata rilascia una scossa sismica#Se distrutta rilascia una scorreggia {{Petrify}} pietrificante e {{Poison}} velenosa", -- Mega Bean
	[352] = "Se viene distrutta una fiammella \"Cannone di Vetro\" vengono distrutte anche tutte le altre", -- Glass Cannon
	[357] = "Duplica tutte le fiammelle fino all'uscita dalla stanza", -- Box of Friends
	[382] = "I nemici amichevoli generano 1 tra 4 fiammelle quando vengono uccisi in base ai loro attacchi, con lacrime normali, a ricerca, esplosive, o di \"Zolfo Fuso\"", -- Friendly Ball
	[383] = "Le lacrime della fiammella possono venire detonate, tramutandosi in 6 lacrime di Isaac#Persiste tra le stanze#Se distrutta scoppia in lacrime di Isaac", -- Tear Detonator
	[386] = "5% di chance che le lacrime rilancino rocce, vasi, teschi o funghi", -- D12
	[396] = "Ogni portale ha 1 fiammella", -- Ventricle Razor
	[406] = "Danni e rateo di fuoco casuali", -- D8
	[421] = "{{Charm}} Se distrutta rilascia una scorreggia ammaliante", -- Kidney Bean
	[422] = "Resuscita tutte le fiammelle distrutte nella stanza precedente", -- Glowing Hourglass
	[427] = "Rimbalza per la stanza, ed esplode se Isaac ci spara sopra#Non può sparare lacrime o infliggere danni da conttatto", -- Mine Crafter
	[434] = "Al posto delle mosche vengono generate fiammelle#Usando fino a 5 mosche crea 1 fiammella con più danni e salute", -- Jar of Wisps
	[437] = "Se si è colpiti per la prima volta attiva l'effetto di \"D7\"", -- D7
	[441] = "{{Chargeable}} Lacrime di \"Zolfo Fuso\" caricabili#Durante un \"Mega Sbotto\" spara continuamente", -- Mega Blast
	[476] = "Se nessun consumabile viene duplicato genera una seconda fiammella", -- D1
	[477] = "Genera fiammelle di tutti gli oggetti attivi assorbiti#Di per sé non genera fiammelle", -- Void
	[478] = "Se distrutta blocca tutti i nemici e i proiettili per 3 secondi", -- Pause
	[479] = "Se distrutta chance di generare un {{Trinket}} ninnolo", -- Smelter
	[480] = "Salute aumentata per ogni consumabile convertito#Se almeno 1 consumabile è stato convertito genera solo 1 fiammella ", -- Compost
	[481] = "5% di chance che le lacrime trasformino i nemici in fiammelle casuali", -- Dataminer
	[482] = "Genera una fiammella casuale", -- Clicker
	[483] = "Se distrutta lascia Bombe Troll", -- Mama Mega!
	[484] = "Se distrutta attiva l'effetto di \"Aspe', Cosa?\"", -- Wait What?
	[485] = "Tutte le fiammelle di \"Penny Storto\" vengono distrutte o duplicate se una di esse viene danneggiata", -- Crooked Penny
	[486] = "Chance di negare i danni subiti da Isaac per poi venire distrutta", -- Dull Razor
	[487] = "Fiammella indistruttibile e permanente#Insegue i nemici per sparargli#Non blocca i proiettili e non infligge danni da contatto", -- Potato Peeler
	[488] = "Genera la fiammella dell'oggetto imitato (la fiamella è casuale se non è un oggetto attivo)", -- Metronome
	[489] = "Effetto extra in base al dado imitato", -- D Infinity
	[490] = "Genera una fiammella casuale#Se distrutta resuscita dopo aver completato una stanza", -- Eden's Soul
	[504] = "Lacrime mirate", -- Brown Nugget
	[507] = "Chance di generare una fiammella per ogni uccisione", -- Sharp Straw
	[510] = "Lacrime di {{Collectible229}} \"Polmone di Monstro\", {{Collectible268}} \"Bebè Marcio\", {{Collectible87}} \"Corna di Loki\" o di {{Collectible118}} \"Zolfo Fuso\"", -- Delirious
	[515] = "Genera una fiammella casuale#Se distrutta resuscita dopo aver completato una stanza", -- Mystery Gift
	[516] = "Le lacrime sparano in 8 direzioni nella maniera di \"Irrigatore\"", -- Sprinkler
	[521] = "Triplo colpo#Comprare qualsiasi cosa distrugge tutte le fiammelle di \"Coupon\"", -- Coupon
	[522] = "I proiettili catturati diventano fiammelle", -- Telekinesis
	[523] = "La fiammella viene generata solo quando vengono rilasciati oggetti#Se distrutta genera un consumabile casuale", -- Moving Box
	[527] = "A completamento stanza le fiammelle aprono bauli/porte", -- Mr. ME!
	[536] = "Converte tutte le fiammelle in {{HalfHeart}} mezzi Cuori Rossi", -- Sacrificial Altar
	[545] = "{{Friendly}} Se distrutta genera un Ossuto amichevole", -- Book of the Dead
	[550] = "10% di chance che le lacrime facciano sì che Mamma calpesti i nemici", -- Broken Shovel
	[552] = "10% di chance che le lacrime facciano sì che Mamma calpesti i nemici", -- Mom's Shovel
	[556] = "Lacrime di {{Collectible118}} \"Zolfo Fuso\" a corto raggio", -- Sulfur
	[557] = "↑ {{Luck}} +0.2 Fortuna per ogni fiammella di \"Biscotto della Fortuna\"", -- Fortune Cookie
	[578] = "La fiammella sgocciola del liquido giallo", -- Free Lemonade
	[580] = "Chance di creare Porte Rosse quando si entra in una nuova stanza", -- Red Key
	[582] = "1 fiammella di \"Fungo Allucinogeno\" max", -- Wavy Cap
	[584] = "Nessun beneficio da copie multiple", -- Book of Virtues
	[604] = "Genera 1-3 fiammelle nel punto d'impatto (fino ad 8 fiammelle)#10% di chance di {{Confusion}} lacrime contundenti", -- Mom's Bracelet
	[609] = "50% di chance di generare una fiammella invincibile#50% di chance che se usato tutte le fiammelle di \"D6 Eterno\" vengano distrutte", -- Eternal D6
	[611] = "Salute e danni aumentano in base alle cariche", -- Larynx
	[622] = "Rimpiazza tutte le fiammelle con 3 fiammelle normali", -- Genesis
	[631] = "Divide tutte le fiammelle a metà (metà dei danni)#Le fiammelle divise per una terza volta vengono distrutte", -- Meat Cleaver
	[638] = "Immunità ai proiettili#Al contatto con i nemici che non sono boss", -- Eraser
	[639] = "Al posto di sparare lacrime genera mosche blu", -- Yuck Heart
	[640] = "Chance di lacrime dalla fiamma blu", -- Urn of Souls
	[650] = "Quando \"Bebè Plum\" rimbalza diagonalmente, tutte le fiammelle di \"Flauto Plum\" sono invincibili e rimbalzeranno con lei", -- Plum Flute
	[653] = "I fantasmi rossi possono sparare lacrime", -- Vade Retro
	[655] = "Fiammelle temporanee durante l'uso", -- Spin to Win
	[685] = "Triplica le fiammelle generate", -- Jar of Wisps
	[687] = "Genera una fiammella casuale", -- Friend Finder
	[705] = "Fiammella per una singola stanza per ogni nemico ucciso", -- Dark Arts
	...
	[719] = "20% di chance che i nemici lascino 1 {{Coin}} moneta quando vengono uccisi", -- Keeper's Box
	...
	[723] = "Genera una fiammella casuale e risorteggia tutte le fiammelle in quel tipo", -- Spindown Dice
	[728] = "Tutte le fiammelle orbitano attorno a \"Gellò\" mentre viene usato", -- Gello
}
...
[3] = "{{Collectible284}} Se infligge danni risorteggia i nemici",
...
EID.descriptions[languageCode].TearFlagNames = {
    ...
    [17] = "Anti-Gravità",     -- Anti gravity type tear (floats in place for some time before finally moving) (unset after first update)
...
local repCarBattery = {
	...
	[722] = "{{Chained}} Incatena 2 nemici#Se c'è solo un nemico lo incatena per 10 secondi#Usare nuovamente \"Anima Sola\" libera il nemico più vicino", -- Anima Sola
...
local repTrinkets={
	...
	[98] = {"98", "Pepita Verde", "5% di chance di sparare lacrime adesive a ricerca#{{Damage}} Le caccole infliggono i danni di Isaac 1 volta al secondo#Le lacrime si incollano per 10 secondi"}, -- Nose Goblin
	...
	[138] = {"138", "'M", "Usare un oggetto attivo lo risorteggia"}, -- 'M
	...
	[167] = {"167", "Osso Levigato", "{{Friendly}} Completare una stanza ha il 25% di chance di generare un Ossuto amichevole"}, -- Polished Bone
	...
	[188] = {"188", "Cubo di Ghiaccio", "{{Petrify}} Entrare in una stanza ha il 20% di chance di pietrificare nemici casuali#{{Freezing}} Uccidere un nemico pietrificato lo congela"}, -- Ice Cube
...
local repCards={
	...
	[51] = {"51", "Carta Santa", "Scudo monouso di \"Manto Sacro\" (previene i danni per 1 volta)"}, -- Holy card
	...
	[69] = {"69", "XIII - Morte?", "{{Collectible545}} Attiva \"Libro dei Morti\"#{{Friendly}} Genera entità d'ossa amichevoli per ogni nemico ucciso nella stanza"}, -- XIII - Death?
	...
	[80] = {"80", "Carta Jolly", "Copia l'effetto della pillola, carta, runa, pietra dell'anima o oggetto attivati più di recente"}, -- Wild Card
	...
	[90] = {"90", "Anima di Eden", "Risorteggia i piedistalli e i consumabili nella stanza#Gli oggetti risorteggiati appartengono a categorie di oggetti casuali"}, -- Soul of Eden
...
local repCharacterInfo = {
	...
	[8] = {"Lazzaro", "1 volta per piano, se muore:#Resuscita come Lazzaro Risorto#Perde 1 Portacuori#↑ {{Damage}} +0.5 Danni"},
	...
	[30] = {"Eden Corrotto", "Quando si subiscono danni risorteggia le sue statistiche, oggetti, ninnoli e consumabili#Gli oggetti vengono risorteggiati in un oggetto della stessa categoria#Il danno autoinflitto non conta"},
	[31] = {"Lo Smarrito Corrotto", "Le carte generate hanno il 10% di chance di essere \"Carta Santa\"#Gli oggetti di Qualità {{Quality2}} o inferiori hanno il 20% di chance di venire risorteggiati#Possono essere generati solo oggetti 'offensivi'"},
...
EID.descriptions[languageCode].birthright ={
	...
	{"Eden Corrotto", "", "Ogni oggetto ottenuto prima di \"Primogenitura\" non può più venire risorteggiato#Gli oggetti attivi possono venire risorteggiati, se buttati a terra e poi ripresi"},
	...
	{"Giacobbe Corrotto", "", "Esaù Oscuro si divide in due, creando un clone d'ombra di sé stesso#Entrambi gli Esaù caricano sempre nello stesso momento#{{Collectible722}} Il tempo di attesa di \"Anima Sola\" è ridotto a 10 secondi#{{Chained}} Usare \"Anima Sola\" incatena entrambi gli Esaù per 6.67 secondi"},
	...
	{"L'Anima di Giacobbe Corrotta", "", "Esaù Oscuro si divide in due, creando un clone d'ombra di sé stesso#Entrambi gli Esaù caricano sempre nello stesso momento#{{Collectible722}} Il tempo di attesa di \"Anima Sola\" è ridotto a 10 secondi#{{Chained}} Usare \"Anima Sola\" incatena entrambi gli Esaù per 6.67 secondi"},
...
local repConditions = {
	...
	["5.100.722"] = {"{{Chained}} Incatena Esaù Oscuro#Dopo 5 secondi o dopo aver riusato \"Anima Sola\", si libera lanciandosi verso Jacob"}, -- TJacob + Anima Sola
	...
	["1000.76.1"] = "{{Warning}} Risorteggia solo il personaggio che ha attivato il dado", -- Dice Room 1 (Co-op)
	["1000.76.6"] = "{{Warning}} In co-op vengono risorteggiati tutti gli oggetti dei personaggi!", -- Dice Room 6 (Co-op)
