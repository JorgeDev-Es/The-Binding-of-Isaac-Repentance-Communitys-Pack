...
function mod:connipshitHurt(npc, damage, flag, source)
	if flag & DamageFlag.DAMAGE_EXPLOSION ~= 0 and source and source.Entity and source.Entity.SpawnerEntity and source.Entity.SpawnerEntity.Type == 114 and source.Entity.SpawnerEntity.Variant == 2 then
