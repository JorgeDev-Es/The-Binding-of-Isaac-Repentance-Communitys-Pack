...
function mod:grimaceRockUpdate(player, basedata)
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK1) then -- Grimace
		if data.refreshGrimaceRocks1 and data.grimaceRock1 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK1 then
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK2) then -- Vomit Grimace
		if data.refreshGrimaceRocks1 and data.grimaceRock2 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK2 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK3) then -- Wetstone
		if data.refreshGrimaceRocks1 and data.grimaceRock3 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK3 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK4) then -- Constant Stone Shooter
		if data.refreshGrimaceRocks1 and data.grimaceRock4 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK4 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK5) then -- Broken Gaping Maw
		if data.refreshGrimaceRocks1 and data.grimaceRock5 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK5 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK6) then -- Brimstone Head
		if data.refreshGrimaceRocks1 and data.grimaceRock6 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK6 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK7) then -- Cross Stone Shooter
		if data.refreshGrimaceRocks1 and data.grimaceRock7 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK7 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK8) then -- Stone Eye
		if data.refreshGrimaceRocks1 and data.grimaceRock8 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK8 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK9) then -- Cauldron
		if data.refreshGrimaceRocks1 and data.grimaceRock9 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK9 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK10) then -- Gaping Maw
		if data.refreshGrimaceRocks1 and data.grimaceRock10 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK10 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK11) then -- Triple Grimace
		if data.refreshGrimaceRocks1 and data.grimaceRock11 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK11 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	if player:HasTrinket(FiendFolio.ITEM.ROCK.GRIMACE_ROCK12) then -- Sensory Grimace
		if data.refreshGrimaceRocks1 and data.grimaceRock12 then
			if #data.grimaceRockPositions > 0 then
				for i=1,#data.grimaceRockPositions do
					if data.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK12 then
						data.refreshGrimaceRocks = i-1
						break
					end
				end
	...
	for i = 1, game:GetNumPlayers() do
		...
		if Isaac.GetChallenge() == mod.challenges.towerOffense then
			...
			if game:GetRoom():GetType() == RoomType.ROOM_BOSS then
				...
				p:AddTrinket(mod.grimaceRocks2[nums[4]])
				p:UseActiveItem(CollectibleType.COLLECTIBLE_SMELTER, UseFlag.USE_NOANIM, -1)
				p:AddTrinket(mod.grimaceRocks2[nums[5]] + TrinketType.TRINKET_GOLDEN_FLAG)
				p:AddTrinket(mod.grimaceRocks2[nums[6]] + TrinketType.TRINKET_GOLDEN_FLAG)
			end
		end
	end
end)
	...
	if e.Parent then
		...
		if e.SubType == 0 then -- Grimace
			...
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK1 then
					entry = i-1
		...
		elseif e.SubType == 1 then -- Vomit Grimace
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK2 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 2 then -- Wetstone
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK3 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 3 then -- Constant Stone Shooter
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK4 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 4 then -- Broken Gaping Maw
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK5 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 5 then -- Brimstone Head
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK6 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 6 then -- Cross Stone Shooter
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK7 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 7 then -- Stone Eye
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK8 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 8 then -- Cauldron
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK9 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 9 then -- Gaping Maw
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK10 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 10 then -- Triple Grimace
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK11 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
		...
		elseif e.SubType == 11 then -- Sensory Grimace
			local entry = 0
			for i=1,#pData.grimaceRockPositions do
				if pData.grimaceRockPositions[i][2] == FiendFolio.ITEM.ROCK.GRIMACE_ROCK12 then
					entry = i-1
					e.DepthOffset = 10+entry
					e.SpriteOffset = Vector(0,-28*player.SpriteScale.Y-(entry*10))
					e.SpriteScale = player.SpriteScale
...
function mod:grimlinTrinketUpdate(trinket)
	local gold = 1
	if mod:IsGoldTrinket(trinket.SubType) then
		gold = 2
	end
	if Isaac.GetChallenge() == mod.challenges.towerOffense then
		gold = 4
	end
	if mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK1 then -- Grimace
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK2 then -- Vomit Grimace
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK3 then -- Wetstone
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
		local room = game:GetRoom()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK4 then -- Constant Stone Shooter
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
		local rng = trinket:GetDropRNG()
		local room = game:GetRoom()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK5 then -- Broken Gaping Maw
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
		local rng = trinket:GetDropRNG()
		local room = game:GetRoom()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK6 then -- Brimstone Head
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
		local rng = trinket:GetDropRNG()
		local room = game:GetRoom()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK7 then -- Cross Stone Shooter
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
		local rng = trinket:GetDropRNG()
		local room = game:GetRoom()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK8 then -- Stone Eye
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
		local rng = trinket:GetDropRNG()
		local room = game:GetRoom()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK9 then -- Cauldron
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
		local rng = trinket:GetDropRNG()
		local room = game:GetRoom()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK10 then -- Gaping Maw
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
		local rng = trinket:GetDropRNG()
		local room = game:GetRoom()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK11 then -- Triple Grimace
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
	...
	elseif mod:GetRealTrinketId(trinket.SubType) == FiendFolio.ITEM.ROCK.GRIMACE_ROCK12 then -- Sensory Grimace
		local sprite = trinket:GetSprite()
		local data = trinket:GetData()
		local rng = trinket:GetDropRNG()
		local room = game:GetRoom()
...
mod:AddCallback(ModCallbacks.MC_POST_PICKUP_UPDATE, function(_, pickup) --why is the grid collision so weird
	...
	if data.grimaceSucked then
		...
		for _,grim in ipairs(Isaac.FindByType(5,350,-1,false,false)) do
			if grim.SubType == FiendFolio.ITEM.ROCK.GRIMACE_ROCK5 or grim.SubType == FiendFolio.ITEM.ROCK.GRIMACE_ROCK10 then
				notDropped = true
			end
		end
