...
mod.ThreeOfWandsDropTable = {
	...
	{Variant = mod.PICKUP.VARIANT.FIREWORK_BATTERY, SubType = 0,								Unlocked = function() return true end},
	{Variant = mod.PICKUP.VARIANT.VIRTUOUS_BATTERY, SubType = 0,								Unlocked = function() return true end},
	{Variant = mod.PICKUP.VARIANT.POTATO_BATTERY,	SubType = 0,								Unlocked = function() return true end},
	{Variant = mod.PICKUP.VARIANT.CURSED_BATTERY, 	SubType = 0,								Unlocked = function() return true end},
}
