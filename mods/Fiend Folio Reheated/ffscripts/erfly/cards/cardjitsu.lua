...
mod:AddCallback(ModCallbacks.MC_USE_CARD, function(_, cardID, player, flags)
    ...
    ball:Update()
    FiendFolio:trySayAnnouncerLine(mod.Sounds.VACardJitsuSoccer, flags, 40)
...
mod:AddCallback(ModCallbacks.MC_USE_CARD, function(_, cardID, player, flags)
    ...
    FiendFolio:trySayAnnouncerLine(mod.Sounds.VACardJitsuFlooringUpgrade, flags, 20)
...
mod:AddCallback(ModCallbacks.MC_USE_CARD, function(_, cardID, player, flags)
    ...
    FiendFolio:trySayAnnouncerLine(mod.Sounds.VACardJitsuAC3000, flags, 40)
