...
mod.poopyFamiliars = {
	...
	Rare2 =  {4, 5, 6, 12, 13, 14, 666, 667, 668, 670, 671}, --No Gold/Plat
}
...
function mod.getRandomAttackFamiliar(r)
	...
	elseif rand == 11 then
		--Fairy flieses
		local var = mod.ITEM.FAMILIAR.FAIRY_FLY_1
		if r:RandomInt(100) == 1 then
			var = mod.ITEM.FAMILIAR.FAIRY_FLY_3
		elseif r:RandomInt(4) == 1 then
			var = mod.ITEM.FAMILIAR.FAIRY_FLY_2
		end
		val = {3, var, 0}
	else
		--Fiddly Flies
