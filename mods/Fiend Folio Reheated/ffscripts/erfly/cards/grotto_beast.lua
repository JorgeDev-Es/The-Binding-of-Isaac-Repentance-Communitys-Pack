...
mod.GrottoBeasts = {
	Commons = {
		...
		mod.ENT("Edema"),	--Edema
		mod.ENT("Casualty"),	--Casualty
		mod.ENT("Trailblazer"),	--Trailblazer
		mod.ENT("MrSubHorf"),	--Mr. Sub Horf
	...
	Epics = {
		...
		mod.ENT("Zephyr"),	-- Zephyr
		mod.ENT("SaggingSpit"),	-- Sagging Spit
