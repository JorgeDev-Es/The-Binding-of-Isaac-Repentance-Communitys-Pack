...
FiendFolio.GetSegmentsFunctions = {
	...
	[FiendFolio.FF.CorruptedLarry.ID .. " " .. FiendFolio.FF.CorruptedLarry.Var] = function(npc) -- Corrupted Larry (any segment)
		local segments = {npc}
	...
	[EntityType.ENTITY_TURDLET] = function(npc) -- Turdlet
		local segments = {npc}
