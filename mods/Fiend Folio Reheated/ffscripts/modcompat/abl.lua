...
mod.ABLFFBlacklists = {
	...
	{EntityType.ENTITY_RED_GHOST, -1, -1, {"Corpse Eater"}, "small"},
	...
	{mod.FF.Gravin.ID, mod.FF.Gravin.Var, -1, {"Necromancer"}, "stone"},
	...
	{mod.FF.BambooCutter.ID, mod.FF.BambooCutter.Var, -1, {"Coil"}},
	{mod.FF.FrayedNerve.ID, mod.FF.FrayedNerve.Var, -1, {"Corpse Eater"}, nil},
	{mod.FF.Tittle.ID, mod.FF.Tittle.Var, -1, {}, "small"},
	{mod.FF.ShrunkenHead.ID, mod.FF.ShrunkenHead.Var, -1, {}, "small"},
	{mod.FF.Speleo.ID, mod.FF.Speleo.Var, -1, {}, "stone"},
	{mod.FF.Alfil.ID, mod.FF.Alfil.Var, -1, {}, "small"},
	{mod.FF.Litling.ID, mod.FF.Litling.Var, -1, {}, "small"},
	{mod.FF.Buoy.ID, mod.FF.Buoy.Var, -1, {}, "small"},
}
