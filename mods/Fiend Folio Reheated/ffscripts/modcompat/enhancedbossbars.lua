...
local ebbIcons = {
    ...
    },
    {
        ...
        Conditionals = {
            {
                function(entity)
                    return entity:GetData().IsATinyBoy and not (entity:GetData().IsABigBoy or FiendFolio.isBackdrop("Scarred Womb"))
                end,
                ebbFilepath .. "monsoon_small" .. ".png"
            },
            {
                function(entity)
                    return entity:GetData().IsABigBoy and not (entity:GetData().IsATinyBoy or FiendFolio.isBackdrop("Scarred Womb"))
                end,
                ebbFilepath .. "monsoon_big" .. ".png"
            },
            {
                function(entity)
                    return FiendFolio.isBackdrop("Scarred Womb") and not (entity:GetData().IsATinyBoy or entity:GetData().IsABigBoy)
                end,
                ebbFilepath .. "monsoon_blood" .. ".png"
            },
            {
                function(entity)
                    return FiendFolio.isBackdrop("Scarred Womb") and entity:GetData().IsATinyBoy and not entity:GetData().IsABigBoy
                end,
                ebbFilepath .. "monsoon_small_blood" .. ".png"
            },
            {
                function(entity)
                    return FiendFolio.isBackdrop("Scarred Womb") and entity:GetData().IsABigBoy and not entity:GetData().IsATinyBoy
                end,
                ebbFilepath .. "monsoon_big_blood" .. ".png"
            }
        }
    },
    {
    ...
    },
    {
        ...
        Conditionals = {
            {
                function(entity)
                    return entity.Parent and HPBars.Config.Sorting == "Segments"
                end,
                ebbFilepath .. "corrupted_larry_jr_segment" .. ".png"
            },
            {
                function(entity)
                    return HPBars.Config.Sorting == "Bosses"
                end,
                ebbFilepath .. "corrupted_larry_jr_full" .. ".png"
            }
        }
    },
    {
    ...
    {
        BossID = mod.FF.Madomme,
        Sprite = "madomme",
        Conditionals = {
            {
                function(entity)
                    return entity:GetData().state == 7 --Only local enums woo
                end,
                ebbFilepath .. "madomme2" .. ".png"
            }
        }
    },
}
mod.scheduleForUpdate(function()
    if HPBars then
        ...
        if HPBars.BossDefinitions then
            ...
            HPBars.BossDefinitions["69.1"].bossColors = HPBars.BossDefinitions["69.1"].bossColors or {}
            HPBars.BossDefinitions["69.1"].bossColors[mod.FF.AlienLokiiChampion.Sub] = "_green"
            HPBars.BossDefinitions["81.1"].bossColors = HPBars.BossDefinitions["81.1"].bossColors or {}
            HPBars.BossDefinitions["81.1"].bossColors[mod.FF.GrinchKrampus.Sub] = "_grinch"
