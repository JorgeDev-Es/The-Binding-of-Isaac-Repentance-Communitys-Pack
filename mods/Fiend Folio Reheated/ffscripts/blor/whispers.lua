...
function mod:whispersHurt(npc, damage, flag, source)
	if npc.Variant == mod.FF.Whispers.Var then
		if npc.Parent and npc.Parent.Variant == mod.FF.WhispersController.Var then
...
mod:AddPriorityCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, CallbackPriority.LATE, mod.whispersHurt, mod.FFID.Boss)
