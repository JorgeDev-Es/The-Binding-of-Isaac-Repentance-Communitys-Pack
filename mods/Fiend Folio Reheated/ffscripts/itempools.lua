...
do --torture cookie trinkets
	mod.BaseTortureCookieTrinketPool = {
		--on-hit trinkets
		TrinketType.TRINKET_SWALLOWED_PENNY,
		...
		--fortune trinkets
		mod.ITEM.TRINKET.FORTUNE_WORM,
		mod.ITEM.TRINKET.FORTUNE_GRUB,
	}
	mod.ExternalTortureCookieTrinketPoolAdditions = {}
	mod.RegisterCustomItemPool("TORTURE_COOKIE_TRINKETS", mod.CustomItemPoolType.TRINKET, {"BaseTortureCookieTrinketPool", "ExternalTortureCookieTrinketPoolAdditions"})

	function mod.AddItemsToTortureCookieTrinketPool(itemList)
		for _, id in pairs(itemList) do
			table.insert(mod.ExternalTortureCookieTrinketPoolAdditions, id)
		end
	end
end

do -- Tech Items (Used by Electrum & Mystery Gift)
	mod.BaseTechnologyItems = {
		...
		--CollectibleType.COLLECTIBLE_BATTERY_PACK, ehhh, this kinda sucks I'm leaving it out
		--CollectibleType.COLLECTIBLE_BOT_FLY,
	...
	mod.ExternalTechnologyPoolAdditions = {}
	mod.RegisterCustomItemPool("TECHNOLOGY_ITEMS", mod.CustomItemPoolType.COLLECTIBLE, {"BaseTechnologyItems", "ExternalTechnologyPoolAdditions"})

	function mod.AddItemsToTechnologyPool(itemList)
		for _, id in pairs(itemList) do
			table.insert(mod.ExternalTechnologyPoolAdditions, id)
		end
	end
end
