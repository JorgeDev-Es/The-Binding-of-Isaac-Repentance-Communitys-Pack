...
function FiendFolio.FollowPath(entity, speed, path, useDirect, friction, pathThreshold, guwahMode)
    ...
    if guwahMode then
        ...
        local vel = (pos - entity.Position):Resized(speed)
        entity.Velocity = FiendFolio:Lerp(entity.Velocity, vel, friction)
    else
