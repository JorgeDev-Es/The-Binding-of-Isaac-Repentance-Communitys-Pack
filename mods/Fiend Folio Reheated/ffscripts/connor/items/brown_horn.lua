...
local EnemiesByPoopType = {
	NORMAL = {
		...
		{mod.FF.Volt, {Scale = kSmall}},
		{mod.FF.Anode, {Scale = kSmall}},
		{mod.FF.GoldenFlyBomb, {Scale = kSmall}},
		{mod.FF.ShrunkenHead, {Scale = kSmall}},
		{mod.FF.Tittle, {Scale = kSmall}},
	},
	RED = {
		{15, 0, 0},  -- Clotty
		{24, 0, 0},  -- Globin
